      ...
      <section className="block">
        <div className="container">
          <div className="block-head">
            ...
            <p>Three steps from raw PDFs to a structured credit report with citations, charts, and risk flags — generated by AI, grounded in public source documents.</p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3.5rem", alignItems: "center", marginBottom: "5rem" }}>
            <div>
              ...
              <p style={{ fontSize: "1rem", color: "var(--text2)", lineHeight: 1.6, marginBottom: ".9rem" }}>Type an issuer name and MuniReports surfaces public filings from EMMA, state comptroller sites, and the issuer&apos;s own website to assemble a complete credit report in minutes.</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3.5rem", alignItems: "center", marginBottom: "5rem" }}>
            <div>
              ...
              <ul style={{ listStyle: "none", margin: "1rem 0 1.5rem" }}>
                {["12–25 page report with executive summary", "Charts auto-generated from public source data", "Every claim cites the source document", "Export PDF · Share link · Print-ready"].map(item => (
                  <li key={item} style={{ padding: ".4rem 0", fontSize: ".94rem", color: "var(--text2)", display: "flex", gap: ".6rem" }}>
                    <span style={{ color: "var(--accent)", fontWeight: 600 }}>✓</span> {item}
                  </li>
                ))}
