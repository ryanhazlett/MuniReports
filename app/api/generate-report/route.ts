...
- Write narrative text in NORMAL SENTENCE CASE. Do NOT title-case ANY field. This applies ESPECIALLY to climate_risk fields (flood_risk, wildfire_risk, hurricane_risk, heat_risk, description). Capitalize ONLY the first word of each sentence and proper nouns (city names, agency names). Examples:
  ...
  CORRECT: "More than 60% of structures sit within 1.5 miles of the wildland-urban interface."
  WRONG: "More Than 60% Of Structures Sit Within 1.5 Miles Of The Wildland-Urban Interface."
